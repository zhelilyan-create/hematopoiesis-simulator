...
class _ReportCanvas(rl_canvas.Canvas):
    ...
    def _draw_chrome(self, page_num: int, total: int):
        ...
        self.drawString(text_x, h - 9 * mm, "Hematopoiesis Simulator  v0.1.0")
        ...
        self.drawString(MARGIN, 7 * mm,
                        f"Hematopoiesis Simulator v0.1.0  ·  Generated: {self._generated_at}")
...
def generate_pdf(session_data: dict) -> bytes:
    ...
    story.append(Paragraph("Stochastic Cell Differentiation Model  ·  v0.1.0", S["subtitle"]))
    ...
    story.append(Paragraph(
        "Generated by Hematopoiesis Simulator v0.1.0 — Stochastic CTMC Model",
        S["small"]))
