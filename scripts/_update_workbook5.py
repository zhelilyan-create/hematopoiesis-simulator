"""
Append 9 v0.7 epigenetic structure test rows (run_ids 145-153) to calibration workbook.
"""
import json, re
...
SWEEP_OUT     = "scripts/_sweep5_out.txt"
...
FIXED = dict(
    ...
    w_apo_stemness=0.0,
    w_apo_repl=0.005,
    series="v0.7_epigenetic_structure_test",
    hypothesis="epigenetic_bias redistributes differentiation beyond MPP",
)
...
ws.cell(insert_row, 1).value = (
    "SERIES 14 — v0.7 epigenetic structure test, w_diff_epigenetic=[0.03,0.05,0.07], seeds=[42,1,99]"
)
insert_row += 1
